...
public class TestClientServer {
	...
	public static void main(String[] a) {
		final Linda linda = new linda.server.LindaClient(
		...
		new Thread() {
			public void run() {
				...
				// immediat qui marche
				linda.eventRegister(Linda.eventMode.TAKE,
						Linda.eventTiming.IMMEDIATE, motif,
				...
				linda.eventRegister(Linda.eventMode.TAKE,
						Linda.eventTiming.IMMEDIATE, motif2,
						new AsynchronousCallback(new MyCallback12()));
				...
				// affichage enregistrement du take
				// take bloquant
				// réalisation des write par un deuxieme client dans un autre
				// thread
				// débloqué
